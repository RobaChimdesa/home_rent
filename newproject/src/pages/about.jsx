      ...
      <div className="h-screen">
        ...
        <div className="grid h-screen  w-full grid-cols-2 md:grid-cols-1 text-white  font-serif">
          <div className="w-full md:w-1/2  text-2xl md:text:xl text-left m-20 my-3">
            ...
            <p className="text-left text-justify-center">
              {" "}
            ...
            <button
              onClick={handleshow}
              className="bg-blue-700 hover:bg-blue-500 p-2 px-6 rounded-3xl my-4 mx-28 md:my-2 md:px-3 md:mx-28 md:p-0"
            >
          ...
          <div className="w-1/2 mx-40  ">
            <img src="logo512.png" alt="" className="rounded-full" />
          </div>
        </div>
      </div>
    </Layout>
